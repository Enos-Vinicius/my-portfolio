...
export class ProjectsComponent implements OnInit{
  projects: Card[] = [
    ...
    // {id: 4, tooltip: 'Atuação sozinha no projeto', icon: 'pi pi-user', year: '2024', description: '', class: 'background-project', img: '', title: 'RedeMAIS', link: 'https://redemaisbr.com.br/'},
